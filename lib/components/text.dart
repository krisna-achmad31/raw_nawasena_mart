...
class TextRegular extends StatelessWidget {
  ...
  TextRegular({this.label, this.color, this.size, this.textAlign, this.fontWeight, this.textDecoration, this.maxLine, this.height, this.overFlows, this.softWraps, this.functionMove});
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: TextStyle(
          ...
          decoration: textDecoration != null ? textDecoration : TextDecoration.none),
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w100),
